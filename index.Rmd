...
We can see here that Fearless Flyers is clearly the most distinctive category. We can also se
...
This shows the most important distinguishing features between the different playlists.
...
Here we try clustering in the 6 categories we defined at the beginning of this portfolio. As you can see the groups are certainly not pure. I will add more insightful analysis of the clusters later.
